...
public class Main {
    ...
    private static boolean gameState(char[][] board) {
        ...
        // To check if any horizontol combination is formed
        for (int i = 0; i < 3; i++) {
        ...
        //Board contains only 9 moves, Here checking 9 moves are completed including both players
        //Just to check any one is won or draw
